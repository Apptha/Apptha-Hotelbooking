 ...
 */
class Apptha_Reservation_Model_Order extends Mage_Sales_Model_Order {
    /**
    ...
    const XML_PATH_COUPON_TEMPLATE = 'reservation/email/coupon_template';
    ...
    const XML_PATH_EMAIL_SENDER = 'contacts/email/recipient_email';
    /**
     * Order states
     */
    const STATE_NEW = 'new';
...
//        if ($status == 'complete') {
//            $this->_sendcoupon($this->getRealOrderId());
//            
//        }
        return $this;
    }
